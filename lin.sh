...
git clone https://github.com/smiley9000/android_frameworks_native frameworks/native
git clone https://github.com/smiley9000/android_device_samsung_a05m -b lino device/samsung/a05m
